...
import { isTextMsg, isMarkMsg, isHtmlMsg, isChartMsg, isEChartsMsg, isDataMsg, isSvgMsg, isNoteMsg } from "../utils/common";
...
export default {
    ...
    methods: {
        async render() {
            let component = '';
            if(isMarkMsg(this.message) || isNoteMsg(this.message)) {
